    ...
    return {
      ...
      compile: function uiMaskCompilingFunction() {
        ...
        return function uiMaskLinkingFunction(scope, iElement, iAttrs, controller) {
          ...
          //console.log("original place holder "+originalPlaceholder);
          //console.log("mask place holder "+maskPlaceholder);
          ...
          var linkOptions = {};
          if (iAttrs.uiOptions) {
            //console.log("iAttrs.uiOptions :"+ iAttrs.uiOptions);
          ...
          function getPlaceholderChar(i) {
            ...
            //console.log("getPlaceHolderFunc "+ placeholder);
            if (typeof placeholder !== 'undefined' && placeholder[i]) {
                 //console.log("placeHolderVal "+ placeholder[i]);
            ...
            if (typeof mask === 'string') {
              ...
              angular.forEach(splitMask, function (chr, i) {
                ...
                if (linkOptions.maskDefinitions[chr]) {
                  ...
                  //console.log("maskCaretMap "+ maskCaretMap);
                  maskPlaceholder += getPlaceholderChar(i);
                  //console.log("maskPlaceholder "+ maskPlaceholder);
                  //console.log(maskPlaceholder);
                  maskPatterns.push(linkOptions.maskDefinitions[chr]);
                  //console.log("maskPatterns "+ maskPatterns);
                  characterCount++;
                  //console.log("characterCount "+ characterCount);
                  //console.log("isOptional "+ isOptional);
                  if (!isOptional) {
                    minRequiredLength++;
                    //console.log("minRequiredLength "+ minRequiredLength);
                  }
                } else if (chr === '?') {
                    //console.log("chr "+ chr);
                  isOptional = true;
